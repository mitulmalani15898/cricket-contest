        ...
        <v-layout justify-center wrap>
            <v-flex xs12 md4>
                <material-card style="margin-top: 30px">
                    <v-form lazyValidation v-model="valid" ref="form" v-on:submit.prevent="login">
                        <v-container py-0>
                            <v-layout wrap>
                                <v-flex xs12 md12 text-xs-center class="title">
                                    <div class="title">Login</div>
                                </v-flex>
                                <v-flex xs12 md12 v-if="error">
                                ...
                                <v-flex xs12 md12 sm4 text-xs-center>
                                    <v-btn
                                            type="submit"
        ...
        data() {
            return {
                ...
                emailRules: [
                    ...
                    v => /^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$/.test(v) || 'Email must be valid'
                ],
                passwordRules: [
...
<style scoped>
    ...
    .v-card.v-sheet.theme--light {
        box-shadow: 2px 2px 35px 2px rgba(0,0,0,.50);
    }
