    ...
    <v-container>
        <v-dialog v-model="dialog" persistent max-width="500px">
            <template slot="activator">
                <v-btn color="success" @click="modalType='add'">Add Player</v-btn>
            </template>
            <v-card>
                            ...
                            <v-layout wrap>
                                ...
                                <v-flex xs12 sm12 md12>
                                    ...
                                    >
                                        ...
                                        <v-date-picker color="primary" v-model="date" @input="menu2 = false" class="dob"></v-date-picker>
                                    </v-menu>
                                </v-flex>
                                <v-flex xs12 md12>
                                    <v-radio-group
        ...
        <v-dialog v-model="dialogDelete" max-width="290">
            <v-card class="text-xs-center dialog-delete">
                ...
                <v-card-actions>
                    <v-btn color="green darken-1" flat="flat" @click="deletePlayer">
                        Yes
                    </v-btn>
        ...
        >
            <template slot="items" slot-scope="props">
                <tr>
                    <td class="text-xs-center"><img :src="thumbnailPath + props.item.playerImage" alt=""></td>
    ...
    export default {
        ...
        methods: {
            ...
            updateTeam() {
                ...
                formData.append('dob', this.date);
                formData.append('description', this.description);
                this.imageFile ? formData.append('playerImage', this.imageFile) : formData.append('playerImage', 'defaultPlayerImage.png');
